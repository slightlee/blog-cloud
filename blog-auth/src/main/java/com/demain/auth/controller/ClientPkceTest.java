...
public class ClientPkceTest {
    ...
    /**
     * 明文 + 摘要算法，生成 密文
     * @see org.springframework.security.oauth2.server.authorization.authentication.CodeVerifierAuthenticator#codeVerifierValid(java.lang.String, java.lang.String, java.lang.String)
     * 核心逻辑 入口：
     * @see ClientSecretAuthenticationProvider#authenticate(Authentication) 下 Validate the "code_verifier" parameter for the confidential client, if available
     * @see CodeVerifierAuthenticator#authenticate(OAuth2ClientAuthenticationToken, RegisteredClient)
